export const ACTION_LOGIN_START = 0
...
export const TOOLBAR_TITLE_MESSAGES = 'Messages'
export const TOOLBAR_TITLE_ADDING = 'Adding'
export const TOOLBAR_TITLE_CONTACTS = 'Contacts'