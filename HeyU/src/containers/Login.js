      ...
      <View style={styles.container}>
        ...
        <View style={styles.background}>
          ...
          <View style={styles.loginForm}>
            <TextInput placeholder='joindoe@example.com' underlineColorAndroid={'rgba(0,0,0,0)'} placeholderTextColor={'white'} style={styles.textInput} />
            <TextInput secureTextEntry={true} placeholder='•••••••••••••••••••••••' underlineColorAndroid={'rgba(0,0,0,0)'} placeholderTextColor={'white'} style={styles.textInput} />
